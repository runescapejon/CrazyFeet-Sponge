...
public class GuiCommand implements CommandExecutor {
	...
	public CommandResult execute(CommandSource src, CommandContext ctx) throws CommandException {
		...
		invs.query(SlotPos.of(0, 0)).set(border);
		invs.query(SlotPos.of(1, 0)).set(border);
		invs.query(SlotPos.of(2, 0)).set(border);
		invs.query(SlotPos.of(3, 0)).set(border);
		invs.query(SlotPos.of(4, 0)).set(border);
		invs.query(SlotPos.of(5, 0)).set(border);
		invs.query(SlotPos.of(6, 0)).set(border);
		invs.query(SlotPos.of(7, 0)).set(border);
		invs.query(SlotPos.of(8, 0)).set(border);
		//invs.query(SlotPos.of(0, 3)).set(border);
		invs.query(SlotPos.of(1, 3)).set(border);
		invs.query(SlotPos.of(2, 3)).set(border);
		...
		invs.query(SlotPos.of(8, 3)).set(nextpage);
		invs.query(SlotPos.of(7, 3)).set(border);
		invs.query(SlotPos.of(8, 2)).set(border);
		invs.query(SlotPos.of(1, 1)).set(fire);
		invs.query(SlotPos.of(2, 1)).set(heart);
		invs.query(SlotPos.of(3, 1)).set(note);
		invs.query(SlotPos.of(4, 1)).set(magic);
		invs.query(SlotPos.of(5, 1)).set(witch);
		invs.query(SlotPos.of(6, 1)).set(pearl);
		invs.query(SlotPos.of(7, 1)).set(smoke);
		invs.query(SlotPos.of(8, 1)).set(border);
		invs.query(SlotPos.of(0, 1)).set(border);
		...
		invs.query(SlotPos.of(8, 1)).set(border);
		invs.query(SlotPos.of(0, 2)).set(border);
